    ...
    <Card className={rank === 1 ? "border-blue-200 shadow-sm" : ""}>
      <CardContent className="p-4 space-y-3">
        <div className="flex items-start gap-2">
          ...
          <p className="text-sm font-medium text-slate-900 leading-snug">{hypothesis.title}</p>
        </div>
        ...
        <p className="text-xs text-slate-600 leading-relaxed">{hypothesis.description}</p>
        ...
        {hypothesis.recommendedAction && (
          <div className="bg-blue-50 border border-blue-100 rounded-md px-3 py-2">
            <p className="text-xs font-medium text-blue-800 mb-0.5">Recommended Action</p>
            <p className="text-xs text-blue-700">{hypothesis.recommendedAction}</p>
          </div>
        )}
      </CardContent>
    </Card>
